...
public class AccountModelImpl
	...
	static {
		...
		attributeGetterFunctions.put("userName_", Account::getUserName_);
		attributeSetterBiConsumers.put(
			"userName_", (BiConsumer<Account, String>)Account::setUserName_);
		...
		attributeGetterFunctions.put("password2", Account::getPassword2);
		attributeSetterBiConsumers.put(
	...
	public Object clone() {
		...
		accountImpl.setUserName_(getUserName_());
		accountImpl.setGender(getGender());
		accountImpl.setBirthday(getBirthday());
		accountImpl.setPassword1(getPassword1());
		accountImpl.setPassword2(getPassword2());
	...
	public CacheModel<Account> toCacheModel() {
		...
		accountCacheModel.userName_ = getUserName_();

		String userName_ = accountCacheModel.userName_;

		if ((userName_ != null) && (userName_.length() == 0)) {
			accountCacheModel.userName_ = null;
		}
		...
		String password1 = accountCacheModel.password1;

		if ((password1 != null) && (password1.length() == 0)) {
			accountCacheModel.password1 = null;
		}

		accountCacheModel.password2 = getPassword2();

		String password2 = accountCacheModel.password2;

		if ((password2 != null) && (password2.length() == 0)) {
			accountCacheModel.password2 = null;
		}
	...
	private void _setColumnOriginalValues() {
		...
		_columnOriginalValues.put("userName_", _userName_);
	...
	static {
		...
		columnBitmasks.put("userName_", 2048L);

		columnBitmasks.put("gender", 4096L);

		columnBitmasks.put("birthday", 8192L);

		columnBitmasks.put("password1", 16384L);

		columnBitmasks.put("password2", 32768L);

		columnBitmasks.put("homePhone", 65536L);

		columnBitmasks.put("mobilePhone", 131072L);

		columnBitmasks.put("address", 262144L);

		columnBitmasks.put("address2", 524288L);

		columnBitmasks.put("city", 1048576L);

		columnBitmasks.put("state_", 2097152L);

		columnBitmasks.put("zip", 4194304L);

		columnBitmasks.put("securityQuestion", 8388608L);
