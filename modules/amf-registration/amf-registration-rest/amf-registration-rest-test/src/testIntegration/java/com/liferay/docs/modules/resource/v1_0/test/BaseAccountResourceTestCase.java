...
public abstract class BaseAccountResourceTestCase {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("Password2", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						accountDTO1.getPassword2(),
						accountDTO2.getPassword2())) {
			...
			if (Objects.equals("acceptedTou", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						accountDTO1.getAcceptedTou(),
						accountDTO2.getAcceptedTou())) {
			...
			if (Objects.equals("userName_", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						accountDTO1.getUserName_(),
						accountDTO2.getUserName_())) {
			...
			if (Objects.equals("zip", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						accountDTO1.getZip(), accountDTO2.getZip())) {
	...
	protected AccountDTO randomAccountDTO() throws Exception {
		return new AccountDTO() {
			{
				Password2 = RandomTestUtil.randomString();
				acceptedTou = RandomTestUtil.randomString();
				...
				userName_ = RandomTestUtil.randomString();
