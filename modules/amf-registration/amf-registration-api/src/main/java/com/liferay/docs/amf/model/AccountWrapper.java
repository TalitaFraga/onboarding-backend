...
public class AccountWrapper
	...
	public Map<String, Object> getModelAttributes() {
		...
		attributes.put("userName_", getUserName_());
	...
	public void setModelAttributes(Map<String, Object> attributes) {
		...
		String userName_ = (String)attributes.get("userName_");
	...
	/**
	 * Returns the password2 of this account.
	 *
	 * @return the password2 of this account
	 */
	@Override
	...
	/**
	 * Returns the user name_ of this account.
	 *
	 * @return the user name_ of this account
	 */
	@Override
	...
	/**
	 * Sets the password2 of this account.
	 *
	 * @param password2 the password2 of this account
	 */
	@Override
	...
	/**
	 * Sets the user name_ of this account.
	 *
	 * @param userName_ the user name_ of this account
	 */
	@Override
	public void setUserName_(String userName_) {
		model.setUserName_(userName_);
	}
