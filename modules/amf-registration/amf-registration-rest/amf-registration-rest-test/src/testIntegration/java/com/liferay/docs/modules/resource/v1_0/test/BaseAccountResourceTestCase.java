package com.liferay.docs.modules.resource.v1_0.test;
...
import com.liferay.docs.modules.client.http.HttpInvoker;
import com.liferay.docs.modules.client.pagination.Page;
import com.liferay.docs.modules.client.resource.v1_0.AccountResource;
...
public abstract class BaseAccountResourceTestCase {
	...
	public void testEscapeRegexInStringFields() throws Exception {
		...
		account.setPassword2(regex);
		account.setAcceptedTou(regex);
		...
		account.setUserName_(regex);
		account.setZip(regex);
		...
		Assert.assertEquals(regex, account.getPassword2());
		Assert.assertEquals(regex, account.getAcceptedTou());
		...
		Assert.assertEquals(regex, account.getUserName_());
		Assert.assertEquals(regex, account.getZip());
	}
	...
	protected void assertValid(Account account) throws Exception {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("acceptedTou", additionalAssertFieldName)) {
			...
			if (Objects.equals("userName_", additionalAssertFieldName)) {
	...
	protected List<GraphQLField> getGraphQLFields() throws Exception {
		...
		for (java.lang.reflect.Field field :
				getDeclaredFields(
					com.liferay.docs.modules.dto.v1_0.Account.class)) {
		...
		for (String additionalAssertFieldName :
			...
			if (Objects.equals("Password2", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						account1.getPassword2(), account2.getPassword2())) {
			...
			if (Objects.equals("acceptedTou", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						account1.getAcceptedTou(), account2.getAcceptedTou())) {
			...
			if (Objects.equals("userName_", additionalAssertFieldName)) {
				if (!Objects.deepEquals(
						account1.getUserName_(), account2.getUserName_())) {
			...
			if (Objects.equals("zip", additionalAssertFieldName)) {
				if (!Objects.deepEquals(account1.getZip(), account2.getZip())) {
					return false;
				}
	...
	protected String getFilterString(
		...
		if (entityFieldName.equals("Password2")) {
			sb.append("'");
			sb.append(String.valueOf(account.getPassword2()));
			sb.append("'");

			return sb.toString();
		}

		if (entityFieldName.equals("acceptedTou")) {
			sb.append("'");
			sb.append(String.valueOf(account.getAcceptedTou()));
			sb.append("'");
		...
		if (entityFieldName.equals("userName_")) {
			sb.append("'");
			sb.append(String.valueOf(account.getUserName_()));
			sb.append("'");
		...
		if (entityFieldName.equals("zip")) {
			sb.append("'");
			sb.append(String.valueOf(account.getZip()));
			sb.append("'");
		...
		return new Account() {
			{
				...
				acceptedTou = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
				...
				userName_ = StringUtil.toLowerCase(
					RandomTestUtil.randomString());
	...
	@Inject
	private com.liferay.docs.modules.resource.v1_0.AccountResource
		_accountResource;
